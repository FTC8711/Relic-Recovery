...
public class BlueCloseAutoMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.driveToPosition(RobotHardware.DriveMode.BACKWARD, 0.3, -700);
        ...
        Actions.driveByTime(RobotHardware.DriveMode.STRAFE_RIGHT, 0.55, 700);
        Actions.turnToAngle(90, 0.5, 2);


        // TODO: Implement glyph scoring portion of auto

        double wallDistance = robot.getRangeDistance() + 6;
        ...
        columnsPassed = 1;
        wallDistance = robot.getRangeDistance() + 6;
        ...
        Actions.driveByTime(RobotHardware.DriveMode.BACKWARD, 0.4, 1000);

        robot.setIntake(Constants.INTAKE_SPEED);
        Actions.setRampPosition(-470.0);
        robot.setIntake(0);
